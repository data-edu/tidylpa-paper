...
Cairns, 1996; see Linnenbrink-Garcia & Wormington, 2017, for a recent review),
though is now widely used in educational, social, personality, and other domains
of psychology, is an example of a general mixture model (Harring & Hodis, 2016;
...
Finally, we offer some informed recommendations for researchers aiming to use
LPA in their applied work, and conclude with reflections on the role of
