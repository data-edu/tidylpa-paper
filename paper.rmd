...
`estimate_profiles()` to "mplus" or "MplusAutomation" (either will work):
...
curry_mac_mclust_solutions <- curry_mac %>% 
  select(KinshipR:PossessionR, 
         KinshipJ:PossessionJ) %>% 
...
write_rds(curry_mac_mclust_solutions, "cm_mclust.rds")
