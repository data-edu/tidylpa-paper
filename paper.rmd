...
compare_solutions(many_analyses)
...
We can also create a faceted plot of density plots for an object of class 'tidyLPA'. For each variable, a Total density plot will be shown, along with separate density plots for each latent class, where cases are weighted by the posterior probability of being assigned to that class:
...
Last, we can create a faceted plot of two-dimensional correlation plots and unidimensional density plots for an object of class 'tidyProfile':
...
compare_solutions(many_analyses_mplus)
```
