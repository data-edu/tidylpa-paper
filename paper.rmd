...
Here, we use a simulated dataset contains data on moral relevance and judgment across the seven domains of the *Morality As Cooperation* scale. More on this scale can be found in Curry et al., (2019). 
...
```{r, compare-mplus-starts, eval = TRUE}
